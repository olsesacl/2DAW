...
var width = 350;            // width and height of canvas
var height = 100;
...
var timespent = 5;          // total time spent so far, used to calculate average frame render duration
var frameratespan;          // html span element for updating performance number
var numero_repepeticiones = 200;
...
var prefs = {
    ...
    randomize: true,        // randomize position of new branches
    fade: true,             // fade existing graphics on each frame
...
function draw_frame() {
    ...
    if(numero_repepeticiones == 0){
        clearInterval(refreshIntervalId);
    }else {
        numero_repepeticiones--;
    }
...
function setup_canvas() {
    var canvas = document.getElementById("header_logo");
    canvas.width = width;
    ...
    document.getElementById("header_logo").onclick = paper_click;
}
...
function setup() {
    ...
    refreshIntervalId = setInterval(draw_frame, frame_time);
}