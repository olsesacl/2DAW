...
function mostrar(id){
    ...
    if(id == 2){
        var ports = [
            ...
            ["Envalira", "23", "2404", "El puerto de Envalira es el puerto de montaña con carretera más alto de los Pirineos, con 2.409 metros de altura sobre el nivel del mar, situado en Andorra entre las localidades de Soldeu y Pas de la Casa y el único acceso desde Andorra hacia Francia."],
            ["Aubisque", "22", "1709", "Se trata de un paso habitual del Tour de Francia, catalogado como una subida de categoría especial. El primer paso se realizó en el Tour de Francia de 1910, y desde entonces se ha subido con una frecuencia mayor a una vez cada dos años."]
        ];
    }else if(id == 3){
        var ports = [
            "Alps",
    ...
    for(var i = 1; i < ports.length; i++){
        ...
        //fotos
        dades +="<td><a href='./ports/"+ id +"/"+ i +"/1.jpg' data-lightbox='fotos_"+ id +"_"+ i +"'>Galeria</a></td>";
        //el resto de fotos, aqui se ocultaran ya que no queremos verlas hasta pulsar en la galeria
        var i = 2;
        var exist = true;
        do{
            var file = "./ports/"+ id +"/"+ i +"/1.jpg";

            if(UrlExists(file)==404){
                exist = false;
            }
            i++;
        ...
        dades +="</tr>";
        dades +="<tr id='port_"+ id +"_"+ i +"' style='display:none;opacity:0;'><td colspan='4' class='text_port'>"+ ports[i][3] +"</td></tr>";
    }
    dades +="</table>"
